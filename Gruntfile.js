module.exports = function (grunt) {
  ...
  // Trying these as they appear in main
  var token = grunt.option('token') || config.main.token;
  var protocol = grunt.option('protocol') || config.main.protocol; 
  var hostname = grunt.option('hostname') || config.main.hostname;
  var port = grunt.option('port') || config.main.port;
  var path = grunt.option('path') || config.main.path;
  var branch = grunt.option('branch') || config.main.branch;
